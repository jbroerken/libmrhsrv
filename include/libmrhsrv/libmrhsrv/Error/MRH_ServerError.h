...
extern "C"
{
    ...
    typedef enum
    {
        ...
        // Encryption
        MRH_SERVER_ERROR_ENCRYPTION_INIT = 3,
        MRH_SERVER_ERROR_ENCRYPTION_FAILED = 4,
        MRH_SERVER_ERROR_ENCRYPTION_PW_HASH_MEM = 5,
        
        // MsQuic
        MRH_SERVER_ERROR_MSQUIC_API_TABLE = 6,
        MRH_SERVER_ERROR_MSQUIC_REGISTRATION = 7,
        MRH_SERVER_ERROR_MSQUIC_CONFIGURATION,
